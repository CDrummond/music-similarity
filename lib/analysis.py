...
TRACKS_PER_DB_COMMIT_BLISS_MUSLY = 500
...
def process_files(config, trks_db, allfiles):
    ...
    tracks_per_db_commit = TRACKS_PER_DB_COMMIT_ESSENTIA if config['essentia']['enabled'] else TRACKS_PER_DB_COMMIT_BLISS_MUSLY
